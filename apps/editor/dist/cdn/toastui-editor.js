 ...
 */
function createWidgetContent(info, content) {
...
function htmlToWwConvertors_isCustomInline(node) {
    return node.type === 'customInline';
}
    ...
    tableCell: function (state, node, _a) {
        ...
        if (!node.ignored) {
            var hasParaNode = function (childNode) {
                return childNode &&
                    (htmlToWwConvertors_isInlineNode(childNode) ||
                        htmlToWwConvertors_isCustomInline(childNode) ||
